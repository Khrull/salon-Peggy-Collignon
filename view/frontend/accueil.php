...
<?php ob_start(); ?>
<div class="container-fluid prez">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-4 reveal-2 presfemme">
                        <img class="img-fluid" src="public/images/logofemme.png" alt="salon peggy collignon">
                    </div>
        ...
        Nous vous assurons également des conseils avisés pour le choix de la coupe, la coiffure ou la coloration idéale. 
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 reveal-2 presbarbier">
                        <img class="img-fluid" src="public/images/logohomme.png" alt="salon peggy collignon">
                    </div>
                </div>
                <div class="wrapper">
                <div class="divider div-transparent"></div>
        ...
        <div class="container-fluid localisation">
            <div class="row">
                <div class="col align-self-start reveal-1">
                    ...
                    <dd class="col-sm-9 font-weight-bold">03 87 52 78 22</dd>
                </div>
